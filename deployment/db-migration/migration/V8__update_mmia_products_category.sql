...
UPDATE program_products SET productcategoryid = (SELECT id FROM product_categories WHERE name='Adult')
FROM products p WHERE p.id = program_products.productid AND p.code='08S42';

UPDATE program_products SET productcategoryid = (SELECT id FROM product_categories WHERE name='Adult')
FROM products p WHERE p.id = program_products.productid AND p.code='08S18';
...
UPDATE program_products SET productcategoryid = (SELECT id FROM product_categories WHERE name='Adult')
FROM products p WHERE p.id = program_products.productid AND p.code='08S39';
...
UPDATE program_products SET productcategoryid = (SELECT id FROM product_categories WHERE name='Children')
...
UPDATE program_products SET productcategoryid = (SELECT id FROM product_categories WHERE name='Solution')
